...
The local laboratory records scenario outcomes under declared test conditions. Those results demonstrate the exercised workflow, not production readiness.
